...
vim.keymap.set('n', '<leader>r', function()
  require('related-files').pick()
end, { desc = 'Pick related file', silent = true, buffer = true })
```
...
When `:RelatedFiles` or `require('related-files').pick()` is invoked, items are sorted by:
